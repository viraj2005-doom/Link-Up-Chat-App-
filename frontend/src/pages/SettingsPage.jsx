      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">
            Choose a theme for your chat interface. {THEMES.length} DaisyUI themes are available.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 gap-2">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-1.5 p-2 rounded-lg border transition-colors
                ${
                  theme === t
